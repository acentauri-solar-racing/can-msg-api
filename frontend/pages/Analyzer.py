...
max_time_offset = 5  # Time offset between two measurements such that they are considered simultaneously. This is used
# for summing the MPPT-measurements together. In seconds
